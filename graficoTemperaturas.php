        ...
        <script type="text/javascript">
          ...
          function drawChart() {
            var data = google.visualization.arrayToDataTable([
              ['Data', 'Temperatura da Placa', 'Temperatura Ambiente'],
            <?php
            ...
            // Selecionando os dados da tabela medidas que serão mostrados no período de data determinado
                $query_temperaturas = "SELECT temperaturaAmbiente,temperaturaPlaca,created FROM medidas WHERE created BETWEEN :data_inicio AND :data_final";
            ...
            ?>
              ['<?php echo"".$row_medidas['created']; ?>',<?php echo"".$row_medidas['temperaturaAmbiente']?> , <?php echo"".$row_medidas['temperaturaPlaca']?>],
              <?php }}?>
            ]);
