        ...
        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            // Selecionando os dados da tabela medidas que serão mostrados no período de data determinado
                $query_temperaturas = "SELECT Potencia,created FROM medidas WHERE created BETWEEN :data_inicio AND :data_final";
            ...
            ?>
              ['<?php echo"".$row_medidas['created']; ?>',<?php echo"".$row_medidas['Potencia']?>],
              <?php }}?>
            ]);
